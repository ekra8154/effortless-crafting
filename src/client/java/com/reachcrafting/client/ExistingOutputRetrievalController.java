...
public final class ExistingOutputRetrievalController {
	...
	static void setEnabled(boolean enabled) {
		...
		ReachCraftingMod.diag("[retrieval_mode] setEnabled next={} screen={}", next, Minecraft.getInstance().gui.screen() != null ? Minecraft.getInstance().gui.screen().getClass().getSimpleName() : "null");
