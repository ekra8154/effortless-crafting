...
public final class RecipeButtonNearbyIndicator {
	...
	private static void renderPattern(net.minecraft.client.gui.GuiGraphicsExtractor guiGraphics, int centerX, int centerY, String pattern, int color) {
		renderPattern(guiGraphics, centerX, centerY, pattern, color, 1.0f);
	}

	private static void renderPattern(net.minecraft.client.gui.GuiGraphicsExtractor guiGraphics, int centerX, int centerY, String pattern, int color, float scale) {
