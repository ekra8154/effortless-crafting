...
final class ClickStageUpgrade {
	...
	static void arm(Recipe<?> holder, RecipeCollection recipeCollection, int menuContainerId, int copies, int index) {
		recipe = holder;
	...
	private static void tick(Minecraft client) {
		...
		RecipeIngredientSummary summary = GridTopUp.resolveSummary(client, recipe.getId(), collection);
		if (summary == null) {
			clear();
			return;
		}
