...
final class ClickStageUpgrade {
	...
	private static RecipeDisplayId recipeId;
	...
	static void arm(RecipeDisplayId id, RecipeCollection recipeCollection, int menuContainerId, int copies, int index) {
		recipeId = id;
	...
	private static void tick(Minecraft client) {
		...
		RecipeIngredientSummary summary = GridTopUp.resolveSummary(client, recipeId, collection);
		if (summary == null) {
			clear();
			return;
		}
