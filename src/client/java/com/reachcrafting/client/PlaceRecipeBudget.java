...
public final class PlaceRecipeBudget {
	...
	private record PendingPlace(int containerId, RecipeHolder<?> recipeId, boolean useMaxItems) {
	}
	 ...
	 */
	public static boolean permitOrDefer(Minecraft client, int containerId, RecipeHolder<?> recipeId, boolean useMaxItems) {
