...
public final class PlaceRecipeBudget {
	...
	private record PendingPlace(int containerId, Recipe<?> recipeId, boolean useMaxItems) {
	}
	 ...
	 */
	public static boolean permitOrDefer(Minecraft client, int containerId, Recipe<?> recipeId, boolean useMaxItems) {
